...
module.exports = (client) => {
    client.generateSelect = async function (id, labels) {
        ...
        let row = new Discord.AvtionRowBuilder();
        let row2 = new Discord.AvtionRowBuilder();
        let row3 = new Discord.AvtionRowBuilder();
        let row4 = new Discord.AvtionRowBuilder();
        let row5 = new Discord.AvtionRowBuilder();
        ...
        if (labels.length < 75 && labels.length > 50 || labels.length == 75) {
            ...
            const menu3 = new Discord.ActionRowBuilder()
                .setCustomId(`${id}-3`)
                .setPlaceholder('❌┇Nothing selected')
        ...
        if (labels.length < 100 && labels.length > 75 || labels.length == 100) {
            ...
            const menu4 = new Discord.ActionRowBuilder()
                .setCustomId(`${id}-4`)
                .setPlaceholder('❌┇Nothing selected')
        ...
        if (labels.length < 125 && labels.length > 100 || labels.length == 125) {
            ...
            const menu5 = new Discord.ActionRowBuilder()
                .setCustomId(`${id}-5`)
                .setPlaceholder('❌┇Nothing selected')
